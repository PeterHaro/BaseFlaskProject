...
class CommonHttpTestCases(unittest.TestCase):
    """MapApplication flask functionality and base http tests"""

    def setUp(self):
        MapApplication.app.debug = True
        self.app = MapApplication.app.test_client()
...
#        self.assertEqual(data['headers']['Content-Type'], '')
  ...
  #      self.assertEqual(data['headers']['Content-Type'], '')
    ...
    def test_post_body_text(self):
        with open('MapApplication/app.py') as f:
